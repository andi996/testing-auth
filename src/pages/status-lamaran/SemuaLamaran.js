...
const SemuaLamaran = ({ data, keyword, handleButton, handleHelpButton }) => {
    ...
    <Box>
      ...
      <Box className="d-flex-fullwidth" mb={Mobile ? `4px` : `16px`}>
        <Box className="d-flex" gap="8px">
          ...
          {Mobile && !skeleton && totalData > 0 && (
            <HelpOutline
              style={{ color: Colors.primary.mid_blue, cursor: `pointer` }}
        ...
        <BottomSheet
          ...
          onSubmit={() => {
            ...
            // setStatusLowongan(filterValue?.statusLowongan);
            // setStatusProfileMatch(filterValue?.statusProfileMatch);
          }}
