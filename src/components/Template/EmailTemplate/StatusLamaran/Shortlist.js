                      ...
                      >
                        <tbody>
                          <tr>
                            ...
                            >
                              Selamat! Lamaran Anda
                              <br />
                              telah di-
                              <i>shortlist</i> di [nama perusahaan]!
                            </td>
                          </tr>
                          <tr>
                            <td
                          ...
                          <tr>
                            ...
                            >
                              Lamaran Anda ke [nama perusahaan] untuk posisi
                              UI/UX Designer sedang ditinjau.
                              <br />
                              <br />
                              Proses peninjauan ini menandakan bahwa lamaran
                              Anda sedang ditinjau oleh [nama perusahaan] untuk
                              dipertimbangkan menuju proses selanjutnya.
                              <br />
                              <br />
                              Sambil menunggu jawaban recruiter, Anda bisa
                              melakukan pencarian lebih lanjut pada perusahaan
                              tersebut untuk memastikan perusahaan tersebut sah.
                              Pastikan Anda mengecek situs web perusahaan,
                              alamat email, dan posting pekerjaan mereka.
                              <br />
                              <br />
                              Good Luck,
                              <br />
                          ...
                          <tr>
                            <td>
                              <button
                                onClick={() =>
                                  window.open(
                                    "https://www.karir.com/users/account"
                                  )
                                }
                                style={{
                                  border: 0,
